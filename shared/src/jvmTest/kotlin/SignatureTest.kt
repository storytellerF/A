...
class SignatureTest {
    ...
    @Test
    fun algorithmsSignAndEncrypt() = runTest {
        loadCryptoLibIfNeed()
        listOf(AlgoP256, AlgoDilithium).forEach { algorithm ->
            ...
            val (encryptionPrivateKey, encryptionPublicKey) = if (algorithm == AlgoDilithium) {
            ...
            val encryptedAesKey = algorithm.encryptionAlgo
    ...
    @Test
    fun p256AddressIsCalculated() = runTest {
        loadCryptoLibIfNeed()
