...
fun createCommunityViewModel(communityId: PrimaryKey): IdCommunityViewModel {
    return viewModel(keys = listOf("community", communityId)) { client, databaseSource ->
...
fun createRoomViewModel(roomAid: String) =
    viewModel(keys = listOf("room", roomAid)) { client, databaseSource ->
...
fun createTopicSearchViewModel(current: String) =
    viewModel(keys = listOf("topic", current)) { client, databaseSource ->
...
fun createTopicViewModel(topicAid: String) =
    viewModel(keys = listOf("topic", topicAid)) { client, databaseSource ->
...
fun createUserViewModel(userAid: String) =
    viewModel(keys = listOf("user", userAid)) { client, databaseSource ->
        AidUserViewModel(client, databaseSource, userAid)
    }

@Composable
fun createUserViewModel(userId: PrimaryKey) =
    viewModel(keys = listOf("user", userId)) { client, databaseSource ->
