...
public class CertInformationCollector {
     ...
     * @throws CertificateProcessingException when there is an error processing the certificates
    ...
    public CertSignatureInformation getLastCertInfo(PDSignature signature, String fileName)
            throws CertificateProcessingException, IOException {
    ...
    private CertSignatureInformation getCertInfo(byte[] signatureContent)
        ...
        try {
            ...
            throw new CertificateProcessingException(e);
        }
        return rootCertInfo;
    }
    ...
    private void addTimestampCerts(SignerInformation signerInformation)
            throws IOException, CertificateProcessingException {
        ...
        if (!(obj0 instanceof ASN1Object tsSeq)) {
            return;
        }
     ...
     * @throws CertificateProcessingException on a specific error with a certificate
     */
    ...
    private void traverseChain(X509Certificate certificate, CertSignatureInformation certInfo,
                               int maxDepth) throws IOException, CertificateProcessingException {
        ...
        try {
            ...
            throw new CertificateProcessingException(ex);
        }
    ...
    private void getAlternativeIssuerCertificate(CertSignatureInformation certInfo, int maxDepth)
            throws CertificateProcessingException {
     ...
     * @throws CertificateProcessingException on failed conversion from X509CertificateHolder to
     *                                        X509Certificate
     */
     ...
     */
    CertSignatureInformation getCertInfo(X509Certificate certificate) throws CertificateProcessingException {
        try {
