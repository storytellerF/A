...
public class CreateSignature extends CreateSignatureBase {
    ...
    private static @NotNull PDSignature getPdSignature() {
        PDSignature signature = new PDSignature();
        signature.setFilter(PDSignature.FILTER_ADOBE_PPKLITE);
        signature.setSubFilter(PDSignature.SUBFILTER_ADBE_PKCS7_DETACHED);
        signature.setName("System");
        signature.setLocation("CA");
        signature.setReason("Snapshot");
    ...
    public void signDetached(PDDocument document, OutputStream output)
        ...
        PDSignature signature = getPdSignature();
