...
object CryptoJvm {
    ...
    fun getDerPublicKeyFromPrivateKey(pemPrivateKeyStr: String): String {
    ...
    fun calcAddress(derPublicKeyStr: String): String {
    ...
    @Suppress("DeprecatedProvider")
    @OptIn(ExperimentalStdlibApi::class)
    fun decrypt(derPrivateKeyStr: String, encrypted: ByteArray, encryptedAesKey: ByteArray): String {
    ...
    @Suppress("DeprecatedProvider")
    @OptIn(ExperimentalStdlibApi::class)
    fun encryptAesKey(derPublicKeyStr: String, aesKey: ByteArray): ByteArray {
