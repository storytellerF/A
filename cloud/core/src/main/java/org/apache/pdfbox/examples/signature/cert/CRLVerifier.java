...
public final class CRLVerifier {
    ...
    private static X509CRL downloadCRLFromLDAP(String ldapURL) throws CertificateException,
        ...
        Attribute aval = getAttribute(ldapURL);
    ...
    private static Attribute getAttribute(String ldapURL) throws NamingException {
        ...
        return avals.get("certificateRevocationList;binary");
    }
     ...
     * Point" extension in an X.509 certificate. If CRL distribution point
    ...
    public static List<String> getCrlDistributionPoints(X509Certificate cert)
        ...
        if (!(derObjCrlDP instanceof ASN1OctetString dosCrlDP)) {
            LOG.warn(
